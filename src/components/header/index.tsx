...
const Header: FC = () => {
  return (
    <header className="border-b border-zinc-200 bg-white flex justify-between items-center px-5 md:px-8 h-16 sticky top-0 z-10 gap-5">
      <form className="flex items-center gap-2 text-zinc-500 bg-zinc-100 rounded-lg px-3 py-2 w-full min-w-0 max-w-xs focus-within:ring-2 focus-within:ring-blue-100 focus-within:bg-white focus-within:border focus-within:border-blue-300 transition">
        <GoSearch className="shrink-0" />

        <input
          type="text"
          placeholder="Ara.."
          className="bg-transparent outline-none text-base sm:text-sm w-full text-zinc-800 placeholder:text-zinc-400"
        />
      </form>
